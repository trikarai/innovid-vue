...
export default {
  ...
  methods: {
    ...
    updatePassword() {
      ...
      this.axios
        .patch(
          config.baseUri + "/personnel/personnel-profile/change-password",
          this.password,
          {
    ...
    updateProfile() {
      ...
      this.axios
        .patch(
          config.baseUri + "/personnel/personnel-profile/update",
          this.profiles,
          {
            headers: auth.getAuthHeader()
          }
        ...
        .then(res => {
          ...
          this.profiles.name = res.data.data.name;
          this.profiles.email = res.data.data.email;
          this.profiles.phone = res.data.data.phone;
        })
        .catch(res => {
          bus.$emit("callNotif", "error", res);
        })
    ...
    getSingleDetail() {
      ...
      // var authData = JSON.parse(auth.getAuthData());
      this.axios
        .get(config.baseUri + "/personnel/personnel-profile", {
          headers: auth.getAuthHeader()
        })
        .then(res => {
